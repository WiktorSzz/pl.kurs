...
public class DataService {
    ...
    public static List<MedicalVisit> createMedicalVisitsFromFile(String fileName, List<Doctor> doctors, List<Patient> patients) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Patient patient = getPatientById(patientId, patients);

                if (doctor != null && patient != null) {
                    MedicalVisit medicalVisit = new MedicalVisit(visitDate, doctor, patient);
    ...
    private static Doctor getDoctorById(int doctorId, List<Doctor> doctors) {
    ...
    private static Patient getPatientById(int patientId, List<Patient> patients) {
    ...
    public static List<Patient> findPatientsWithMinimumDifferentDoctors(List<Patient> patients, int minDifferentDoctors) {
        ...
        for (Patient patient : patients) {
            ...
            for (MedicalVisit visit : patient.getVisits()) {
                int doctorId = visit.getDoctor().getIdNumber();
